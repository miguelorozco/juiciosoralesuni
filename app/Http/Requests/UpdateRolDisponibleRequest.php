...
class UpdateRolDisponibleRequest extends FormRequest
{
    /**
    ...
    {
        // Solo administradores e instructores pueden actualizar roles
    ...
    {
        $rolId = $this->route('rolDisponible')->id ?? $this->route('rolDisponible');
        ...
        return [
            'nombre' => [
                ...
                'max:50',
                'min:2',
                'regex:/^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s\d]+$/u',
                Rule::unique('roles_disponibles', 'nombre')->ignore($rolId)
            ],
            'descripcion' => [
                'nullable',
                'string',
