<?php $__env->startSection('title', 'Dashboard - Simulador de Juicios Orales'); ?>
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">
                        Bienvenido, <span class="fw-semibold text-dark"><?php echo e(auth()->user()->name); ?></span> 
                        <span class="badge bg-<?php echo e(auth()->user()->tipo === 'admin' ? 'danger' : (auth()->user()->tipo === 'instructor' ? 'warning' : 'info')); ?> ms-2">
                            <?php echo e(ucfirst(auth()->user()->tipo)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/miguel/Documents/github/juiciosorales/resources/views/dashboard.blade.php ENDPATH**/ ?>