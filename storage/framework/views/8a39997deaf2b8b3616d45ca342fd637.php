<?php $__env->startSection('title', 'Editor de Diálogos v2 - Simulador de Juicios Orales'); ?>
...
(function() {
    window.dialogoEditorV2 = function() {
        const dialogoData = <?php echo json_encode($dialogo ?? null, 15, 512) ?>;
        const dialogoId = dialogoData ? dialogoData.id : null;
        const rolesDisponibles = <?php echo json_encode($rolesDisponibles ?? [], 15, 512) ?>;
...
<div class="container-fluid py-4" x-data="dialogoEditorV2()" x-init="init()" x-cloak>
    ...
    <?php echo $__env->make('dialogos.v2.modals.validacion', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/miguel/Documents/github/juiciosorales/resources/views/dialogos/v2/editor.blade.php ENDPATH**/ ?>