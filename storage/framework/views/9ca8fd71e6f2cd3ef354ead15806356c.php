...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Simulador de Juicios Orales'); ?></title>
                ...
                <div class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" role="button" data-bs-toggle="dropdown">
                        ...
                        <div class="text-start">
                            <div class="fw-semibold text-dark mb-0"><?php echo e(auth()->user()->name ?? 'Usuario'); ?></div>
                            <small class="text-muted"><?php echo e(ucfirst(auth()->user()->tipo ?? 'usuario')); ?></small>
                        </div>
                    </a>
...
</html><?php /**PATH /home/miguel/Documents/github/juiciosorales/resources/views/layouts/app.blade.php ENDPATH**/ ?>