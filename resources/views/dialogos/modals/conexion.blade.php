        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    ...
                    <span x-text="conexionEditando.id ? 'Editar Conexión' : 'Nueva Conexión'"></span>
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <form @submit.prevent="guardarConexion()">
                    <!-- Nodos de la Conexión -->
                    <div class="row mb-3">
                        <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" rows="2" x-model="conexionEditando.descripcion" 
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" x-model="conexionEditando.orden" 
                                   placeholder="0" min="0">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-medium">Puntuación</label>
                            <input type="number" class="form-control" x-model="conexionEditando.puntuacion" 
                                   placeholder="0" min="0">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-medium">Color</label>
                            <input type="color" class="form-control form-control-color" 
                                   x-model="conexionEditando.color" value="#007bff">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" x-model="conexionEditando.activo">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" @click="eliminarConexion()" 
                        x-show="conexionEditando.id">
                    <i class="bi bi-trash me-1"></i>
                    Eliminar
                </button>
                <button type="button" class="btn btn-primary" @click="guardarConexion()">
                    <i class="bi bi-save me-1"></i>
                    <span x-text="conexionEditando.id ? 'Actualizar' : 'Crear'"></span>
                </button>
            </div>
        </div>
    </div>
