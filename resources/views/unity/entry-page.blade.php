...
@section('title', 'Entrada a Unity - Simulador de Juicios')
            ...
            <div class="card shadow-lg">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0">
                        ...
                        Entrada a Unity - {{ $assignment->sesion->nombre }}
                    </h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <div class="bg-light p-3 rounded">
                                <p><strong>Nombre:</strong> {{ $assignment->sesion->nombre }}</p>
                                <p><strong>Estado:</strong> 
                                    <span class="badge bg-{{ $assignment->sesion->estado === 'en_curso' ? 'success' : 'warning' }}">
                                        {{ ucfirst($assignment->sesion->estado) }}
                                    </span>
                                </p>
                                <p><strong>Fecha:</strong> {{ $assignment->sesion->fecha_inicio->format('d/m/Y H:i') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="bg-light p-3 rounded">
                                <div class="d-flex align-items-center mb-2">
                                    <i class="bi bi-{{ $assignment->rolDisponible->icono ?? 'person' }} me-2" 
                                       style="color: {{ $assignment->rolDisponible->color ?? '#007bff' }}; font-size: 1.5rem;"></i>
                                    <h6 class="mb-0">{{ $assignment->rolDisponible->nombre }}</h6>
                                </div>
                                <p class="text-muted mb-0">{{ $assignment->rolDisponible->descripcion }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6">
                            ...
                            <p class="mb-1"><strong>Nombre:</strong> {{ $assignment->usuario->name }}</p>
                            <p class="mb-1"><strong>Email:</strong> {{ $assignment->usuario->email }}</p>
                            <p class="mb-0"><strong>Asignado:</strong> {{ $assignment->fecha_asignacion->format('d/m/Y H:i') }}</p>
                        </div>
